...
from bert.run_classifier import DataProcessor, InputExample, model_fn_builder
...
class STIProcessor(DataProcessor):
    ...
    def _create_examples(self, lines, set_type):
        ...
        for (i, line) in enumerate(lines):
            ...
            if set_type == "test": # don't understand motivation for this. Should it stay in my version?
                label = "0"
            else:
...
class STIMultilabelProcessor(DataProcessor):
    """multi-label processor for the NASA STI data set."""
...
def main(_):
    ...
    processors = {
        "sti": STIProcessor,
        "stimulti": STIMultilabelProcessor,
    }
    ...
    if FLAGS.do_eval:
        LOG.info('EVAL! data dir: {}'.format(FLAGS.data_dir))
    ...
    if FLAGS.do_predict:
        LOG.info('PREDICT! data dir: {}'.format(FLAGS.data_dir))
